...
#ifndef VERILATED_VC_DECODE___024ROOT_H_
#define VERILATED_VC_DECODE___024ROOT_H_  // guard
...
class Vc_decode___024root final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vc_decode___024root(Vc_decode__Syms* symsp, const char* v__name);
    ~Vc_decode___024root();
    VL_UNCOPYABLE(Vc_decode___024root);
