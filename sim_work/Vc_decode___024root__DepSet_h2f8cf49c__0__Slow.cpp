...
VL_ATTR_COLD void Vc_decode___024root___eval_static(Vc_decode___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vc_decode__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vc_decode___024root___eval_static\n"); );
}

extern const VlWide<13>/*415:0*/ Vc_decode__ConstPool__CONST_h54224645_0;
extern const VlWide<14>/*447:0*/ Vc_decode__ConstPool__CONST_he278731b_0;
extern const VlWide<15>/*479:0*/ Vc_decode__ConstPool__CONST_h6aebc7c9_0;

VL_ATTR_COLD void Vc_decode___024root___eval_initial__TOP(Vc_decode___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vc_decode__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vc_decode___024root___eval_initial__TOP\n"); );
    // Body
    VL_READMEM_N(true, 32, 32, 0, VL_CVT_PACK_STR_NW(13, Vc_decode__ConstPool__CONST_h54224645_0)
                 ,  &(vlSelf->tb_Main_processor__DOT__OG__DOT__instr_memory__DOT__instruction_memory)
                 , 0, ~0ULL);
    VL_READMEM_N(true, 32, 32, 0, VL_CVT_PACK_STR_NW(14, Vc_decode__ConstPool__CONST_he278731b_0)
                 ,  &(vlSelf->tb_Main_processor__DOT__OG__DOT__register_file__DOT__registerfile)
                 , 0, ~0ULL);
    VL_READMEM_N(true, 32, 101, 0, VL_CVT_PACK_STR_NW(15, Vc_decode__ConstPool__CONST_h6aebc7c9_0)
                 ,  &(vlSelf->tb_Main_processor__DOT__OG__DOT__data_memory__DOT__memory)
                 , 0, ~0ULL);
}

VL_ATTR_COLD void Vc_decode___024root___eval_final(Vc_decode___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vc_decode__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vc_decode___024root___eval_final\n"); );
}
...
#endif  // VL_DEBUG
VL_ATTR_COLD void Vc_decode___024root___eval_stl(Vc_decode___024root* vlSelf);

VL_ATTR_COLD void Vc_decode___024root___eval_settle(Vc_decode___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vc_decode__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vc_decode___024root___eval_settle\n"); );
    // Init
    ...
    while (__VstlContinue) {
        __VstlContinue = 0U;
        Vc_decode___024root___eval_triggers__stl(vlSelf);
        if (vlSelf->__VstlTriggered.any()) {
            ...
            Vc_decode___024root___eval_stl(vlSelf);
        }
    }
}
...
VL_ATTR_COLD void Vc_decode___024root___dump_triggers__stl(Vc_decode___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vc_decode__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vc_decode___024root___dump_triggers__stl\n"); );
    // Body
...
VL_ATTR_COLD void Vc_decode___024root___stl_sequent__TOP__0(Vc_decode___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vc_decode__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vc_decode___024root___stl_sequent__TOP__0\n"); );
    // Body
...
VL_ATTR_COLD void Vc_decode___024root___eval_stl(Vc_decode___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vc_decode__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vc_decode___024root___eval_stl\n"); );
    // Body
    if ((1ULL & vlSelf->__VstlTriggered.word(0U))) {
        Vc_decode___024root___stl_sequent__TOP__0(vlSelf);
...
VL_ATTR_COLD void Vc_decode___024root___dump_triggers__act(Vc_decode___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vc_decode__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vc_decode___024root___dump_triggers__act\n"); );
    // Body
...
VL_ATTR_COLD void Vc_decode___024root___dump_triggers__nba(Vc_decode___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vc_decode__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vc_decode___024root___dump_triggers__nba\n"); );
    // Body
...
VL_ATTR_COLD void Vc_decode___024root___ctor_var_reset(Vc_decode___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vc_decode__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vc_decode___024root___ctor_var_reset\n"); );
    // Body
