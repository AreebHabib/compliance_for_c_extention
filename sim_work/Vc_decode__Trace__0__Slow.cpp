...
VL_ATTR_COLD void Vc_decode___024root__trace_init_sub__TOP__0(Vc_decode___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vc_decode__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vc_decode___024root__trace_init_sub__TOP__0\n"); );
    // Init
...
VL_ATTR_COLD void Vc_decode___024root__trace_init_top(Vc_decode___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vc_decode__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vc_decode___024root__trace_init_top\n"); );
    // Body
    Vc_decode___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void Vc_decode___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vc_decode___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vc_decode___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/);

VL_ATTR_COLD void Vc_decode___024root__trace_register(Vc_decode___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vc_decode__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vc_decode___024root__trace_register\n"); );
    // Body
    tracep->addFullCb(&Vc_decode___024root__trace_full_top_0, vlSelf);
    tracep->addChgCb(&Vc_decode___024root__trace_chg_top_0, vlSelf);
    tracep->addCleanupCb(&Vc_decode___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vc_decode___024root__trace_full_sub_0(Vc_decode___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vc_decode___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vc_decode___024root__trace_full_top_0\n"); );
    // Init
    Vc_decode___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vc_decode___024root*>(voidSelf);
    Vc_decode__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vc_decode___024root__trace_full_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vc_decode___024root__trace_full_sub_0(Vc_decode___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vc_decode__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vc_decode___024root__trace_full_sub_0\n"); );
    // Init
